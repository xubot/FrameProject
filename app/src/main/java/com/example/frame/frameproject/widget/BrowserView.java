package com.example.frame.frameproject.widget;
...
import com.example.frame.frameproject.base.action.ActivityAction;
                        ...
                        .request(new OnPermission() {
                            ...
                            public void noPermission(List<String> denied, boolean quick) {
                                ...
                                if (quick) {
                                    ...
                                    XXPermissions.startPermissionActivity(activity, String.valueOf(false));
                                } else {
